  ...
  return (
    <div className="space-y-8 sm:space-y-12">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-panel rounded-3xl p-6 sm:p-8 md:p-10 border border-brand-navy/10 shadow-card">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-start lg:items-end justify-center">
              <Link
                to="/method"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-brand-navy text-white text-sm font-semibold hover:bg-brand-ocean transition-all shadow-md group"
              >
      ...
      {/* 4. Live Classroom Moments Auto Slideshow (Moved up for high-impact visual proof) */}
      <ClassroomGallery />

      {/* 5. Live Statistics Ribbon */}
      <StatsBar />

      {/* 6. Quick Discovery Grid (Demo Class, About, FAQ) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
          ...
          <Link
            to="/demo"
            className="group glass-panel rounded-3xl p-5 sm:p-6 border border-slate-200/85 shadow-card hover:shadow-card-hover hover:-translate-y-1.5 transition-all flex flex-col justify-between"
          >
            <div>
              <div className="w-11 h-11 rounded-2xl bg-brand-orange/10 text-brand-orange flex items-center justify-center mb-3.5 group-hover:scale-110 transition-transform">
                <PlayCircle className="w-6 h-6" />
              </div>
              <h4 className="text-lg sm:text-xl font-serif font-bold text-brand-navy mb-1">
            ...
            <div className="mt-4 pt-3.5 border-t border-slate-200/60 flex items-center justify-between text-xs font-bold text-brand-orange">
          ...
          >
            <div>
              <div className="w-11 h-11 rounded-2xl bg-indigo-500/10 text-indigo-700 flex items-center justify-center mb-3.5 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-4 pt-3.5 border-t border-slate-200/60 flex items-center justify-between text-xs font-bold text-indigo-700">
          ...
          >
            <div>
              <div className="w-11 h-11 rounded-2xl bg-emerald-500/10 text-emerald-700 flex items-center justify-center mb-3.5 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-4 pt-3.5 border-t border-brand-navy/5 flex items-center justify-between text-xs font-bold text-emerald-700">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12">
        <div className="bg-brand-navy text-white rounded-3xl p-6 sm:p-10 relative overflow-hidden bg-chem-dark-grid shadow-2xl">
          <div className="max-w-2xl space-y-3.5 relative z-10">
            ...
            <div className="pt-1.5">
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full btn-luxury-primary text-white text-sm font-semibold transition-all shadow-md"
              >
